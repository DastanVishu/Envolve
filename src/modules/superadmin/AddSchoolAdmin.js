...
class AddSchoolAdmin extends Component {
    state = {
        startDate: new Date()
      };
        ...
        return (
          <div>
            <div className="page-header">
              <h3 className="page-title"> Admin Form </h3>
              ...
              <div className="col-12 grid-margin stretch-card">
                <div className="card">
                  <div className="card-body">
                    ...
                    <p className="card-description">Admin Info</p>
                    <form className="forms-sample">
                      ...
                      <p className="card-description"> Select School </p>
                      <div className="row">
                            <div className="col-md-6">
                                <Form.Group className="row">
